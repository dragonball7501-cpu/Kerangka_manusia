...
export const BONES_DATA: BoneData[] = [
  ...
  },
  {
    ...
    model: {
      ...
      focusPoint: [0, 2.25, 0.15],
      preferredDistance: 1.75,
  ...
  // ================= VERTEBRAL COLUMN / TULANG BELAKANG =================
  {
    ...
    model: {
      ...
      cameraAngle: [0, 0.08, -1],
      labelPosition: [0, 1.95, -0.22],
    },
  },
  {
